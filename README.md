...
| `--slider-entity-row-hover-opacity`  | Hover opacity for the thumb halo                        | `var(--ha-ripple-hover-opacity, 0.08)`                             |
| `--slider-entity-row-pressed-opacity`  | Pressed opacity for the thumb halo while sliding                        | `var(--ha-ripple-pressed-opacity, 0.12)`                             |
