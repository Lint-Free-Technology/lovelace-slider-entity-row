...
To install via HACS, add this repo [https://github.com/Lint-Free-Technology/lovelace-slider-entity-row](https://github.com/Lint-Free-Technology/lovelace-slider-entity-row) as a [custom HACS repository](https://www.hacs.xyz/docs/faq/custom_repositories/) using type `Dashboard`. Use the button above to do this in one step. You are best to remove [thomasloven/lovelace-slider-entity-row](https://github.com/thomasloven/lovelace-slider-entity-row) in your HACS to avoid confusion as to what repo you are using.
